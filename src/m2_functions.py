...
def wt(a,b):
    ...
    turtlegreen = rg.SimpleTurtle("turtle")
    turtleother = rg.SimpleTurtle()
    turtlegreen.pen = rg.Pen("green",b)
    turtleother.pen = rg.Pen(a, 5)
    turtlegreen.forward(100)
    turtleother.backward(100)
