...
def main():
    ...
    even_better_draw_circles(rg.Point(100,0),12,10,"midnight blue",10)
    even_better_draw_circles(rg.Point(-100,-50),5,3,"red",2)
    even_better_draw_circles(rg.Point(123,126),10,8,"yellow",4)
    even_better_draw_circles(rg.Point(-234,-156),17,12,"purple",11)
...
def even_better_draw_circles(point,radii,times,pen_color,thickness):
    ...
    for k in range(1, times):  # k becomes 1, 2, 3, ... as many times as you want

        turtle.pen_up()
        turtle.pen = rg.Pen(pen_color,thickness)

        # Go DOWN radii pixels, ending up pointing east again
        turtle.right(90)
